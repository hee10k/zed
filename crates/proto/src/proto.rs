...
messages!(
    ...
    (LoadCommitRangeDiff, Foreground),
    (LoadCommitRangeDiffResponse, Foreground),
    ...
    (Stash, Background),
    (StashPop, Background),
    (StashPopReply, Background),
    (StashApply, Background),
    (StashDrop, Background),
    (StashRename, Background),
    (StashRenameReply, Background),
    (PendingStashRenameRecoveries, Background),
    (PendingStashRenameRecoveriesReply, Background),
    ...
    (GitTagDetails, Background),
    (GitTagDetailsResponse, Background),
    (GitDeleteRefsOnRemote, Background),
    (GitCherryPick, Background),
    (GitRevertCommit, Background),
    (GitMerge, Background),
    (GitOperationState, Background),
    (GitOperationStateResponse, Background),
    (GitRunOperationAction, Background),
...
request_messages!(
    ...
    (LoadCommitRangeDiff, LoadCommitRangeDiffResponse),
    ...
    (Unstage, Ack),
    (Stash, Ack),
    (StashPop, StashPopReply),
    (StashApply, Ack),
    (StashDrop, Ack),
    (StashRename, StashRenameReply),
    (PendingStashRenameRecoveries, PendingStashRenameRecoveriesReply),
    (UpdateBuffer, Ack),
    ...
    (GitCreateTag, Ack),
    (GitDeleteTag, Ack),
    (GitTagDetails, GitTagDetailsResponse),
    (GitDeleteRefsOnRemote, RemoteMessageResponse),
    (GitCherryPick, Ack),
    (GitRevertCommit, Ack),
    (GitMerge, Ack),
    (GitOperationState, GitOperationStateResponse),
    (GitRunOperationAction, Ack),
    (GitDeleteBranch, Ack),
...
entity_messages!(
    ...
    GitTagDetails,
    GitCherryPick,
    GitDeleteRefsOnRemote,
    GitRevertCommit,
    GitMerge,
    GitOperationState,
    GitRunOperationAction,
    GitDeleteBranch,
    GitCheckoutFiles,
