...
> **Superseded (2026-09-05):** default-session ownership, automatic
> startup/retry, and the old `OpenHerdR`-style open actions implemented by this
> plan have been replaced by the explicit session workflow in
> [herdr session implementation plan](2026-09-05-herdr-session-sync.md).
> The completed central-view tasks below (persistent visibility, layout,
> editor-entity preservation) remain valid history.
